function MessageBubble({ message }) {
  ...
  return (
    <div className={`flex items-start gap-3 px-4 py-3 ${isUser ? 'bg-[#171717]' : 'bg-transparent'}`}>
      {isUser ? (
        /* User avatar - placeholder */
        <div className="w-7 h-7 rounded-full bg-[#2f2f2f] flex items-center justify-center flex-shrink-0 mt-0.5">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M20 21V19C20 17.9391 19.5836 16.9217 18.8284 16.1716C18.0733 15.4164 17.0559 15 16 15H8C6.94407 15 5.92669 15.4164 5.17157 16.1716C4.41645 16.9217 4 17.9391 4 19V21" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            <circle cx="12" cy="7" r="4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
      ) : (
        /* AI avatar - Gemini-inspired */
      ...
      <div className="flex-1 min-w-0">
        <p className={`text-sm whitespace-pre-wrap ${isUser ? 'text-white' : 'text-[#d9d9d9]'}`}>
          {message.content}
        </p>

        {!isUser && (
          <div className="flex items-center gap-2 mt-2">
            <button className="p-1 rounded hover:bg-[#202020] transition-colors" title="Copy">
            ...
            <button className="p-1 rounded hover:bg-[#202020] transition-colors" title="Regenerate">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className="p-1 rounded hover:bg-[#202020] transition-colors" title="Thumbs up">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className="p-1 rounded hover:bg-[#202020] transition-colors" title="Thumbs down">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
